namespace ManualMapInjection.Injection
{
    ...
    /// <summary>
    /// Defines the <see cref="ManualMapInjector" />.
    /// </summary>
    internal class ManualMapInjector
    {
        /// <summary>
        /// Gets or sets a value indicating whether AsyncInjection.
        /// </summary>
        ...
        /// The GetDosHeader.
        /// </summary>
        /// <param name="address">The address<see cref="IntPtr"/>.</param>
        /// <returns>The <see cref="PIMAGE_DOS_HEADER"/>.</returns>
        ...
        /// </summary>
        /// <param name="address">The address<see cref="IntPtr"/>.</param>
        /// <returns>The <see cref="PIMAGE_NT_HEADERS32"/>.</returns>
        ...
        /// The RvaToPointer.
        /// </summary>
        /// <param name="rva">The rva<see cref="uint"/>.</param>
        /// <param name="baseAddress">The baseAddress<see cref="IntPtr"/>.</param>
        /// <returns>The <see cref="IntPtr"/>.</returns>
        ...
        /// <summary>
        /// The InjectDependency.
        /// </summary>
        /// <param name="dependency">The dependency<see cref="string"/>.</param>
        ...
        /// <summary>
        /// The GetRemoteModuleHandleA.
        /// </summary>
        /// <param name="module">The module<see cref="string"/>.</param>
        /// <returns>The <see cref="IntPtr"/>.</returns>
        ...
        /// <summary>
        /// The GetDependencyProcAddressA.
        /// </summary>
        /// <param name="moduleBase">The moduleBase<see cref="IntPtr"/>.</param>
        /// <param name="procName">The procName<see cref="PCHAR"/>.</param>
        /// <returns>The <see cref="IntPtr"/>.</returns>
        ...
        /// <summary>
        /// The ProcessDelayedImportTable.
        /// </summary>
        /// <param name="baseAddress">The baseAddress<see cref="IntPtr"/>.</param>
        /// <param name="remoteAddress">The remoteAddress<see cref="IntPtr"/>.</param>
        /// <returns>The <see cref="bool"/>.</returns>
        ...
        /// <summary>
        /// The ProcessRelocation.
        /// </summary>
        /// <param name="imageBaseDelta">The imageBaseDelta<see cref="uint"/>.</param>
        /// <param name="data">The data<see cref="ushort"/>.</param>
        /// <param name="relocationBase">The relocationBase<see cref="PBYTE"/>.</param>
        /// <returns>The <see cref="bool"/>.</returns>
        ...
        /// <summary>
        /// The GetSectionProtection.
        /// </summary>
        /// <param name="characteristics">The characteristics<see cref="DataSectionFlags"/>.</param>
        ...
        /// The ProcessSection.
        /// </summary>
        /// <param name="name">The name<see cref="char[]"/>.</param>
        /// <param name="baseAddress">The baseAddress<see cref="IntPtr"/>.</param>
        /// <param name="remoteAddress">The remoteAddress<see cref="IntPtr"/>.</param>
        /// <param name="rawData">The rawData<see cref="ulong"/>.</param>
        /// <param name="virtualAddress">The virtualAddress<see cref="ulong"/>.</param>
        /// <param name="rawSize">The rawSize<see cref="ulong"/>.</param>
        /// <param name="virtualSize">The virtualSize<see cref="ulong"/>.</param>
        /// <param name="protectFlag">The protectFlag<see cref="uint"/>.</param>
        /// <returns>The <see cref="bool"/>.</returns>
        ...
        /// <summary>
        /// The ExecuteRemoteThreadBuffer.
        /// </summary>
        /// <param name="threadData">The threadData<see cref="byte[]"/>.</param>
        /// <param name="async">The async<see cref="bool"/>.</param>
        /// <returns>The <see cref="bool"/>.</returns>
        ...
        /// </summary>
        /// <param name="baseAddress">The baseAddress<see cref="IntPtr"/>.</param>
        /// <param name="entrypoint">The entrypoint<see cref="uint"/>.</param>
        /// <param name="async">The async<see cref="bool"/>.</param>
        /// <returns>The <see cref="bool"/>.</returns>
        ...
        /// <returns>The <see cref="GCHandle"/>.</returns>
        ...
        /// The FreeHandle.
        /// </summary>
        /// <param name="handle">The handle<see cref="GCHandle"/>.</param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualMapInjector"/> class.
        /// </summary>
        /// <param name="p">The p<see cref="Process"/>.</param>
